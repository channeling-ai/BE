...
public class QMemberAgree extends EntityPathBase<MemberAgree> {
    ...
    private static final long serialVersionUID = 1616527154L;
    ...
    public final BooleanPath dayContentEmailAgree = createBoolean("dayContentEmailAgree");

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final BooleanPath marketingEmailAgree = createBoolean("marketingEmailAgree");
